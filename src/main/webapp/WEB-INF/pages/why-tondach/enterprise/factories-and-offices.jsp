...
<t:indexpage>
    <title>  Заводи та представництва - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Заводи та представництва</li>
    </ul>
		...
		<div id="content">
            ...
            <h1>
              Заводи та представництва
            </h1>
            <div>
				          

              <p><img style="width: 684px;" src="${Constants.URL}media/1063/map.png" alt="map.png" rel="2213" /></p>
<p> </p>
<div id="factories" style="display: inline-block; font-size: x-small;">
<div class="box">
<div class="box_title">
<div class="title">TONDACH UA</div>
</div>
<div class="box_pad">
<div class="nums">1</div>
Офіс, Центральний склад, Ужгород<br /> Щедріна 146 <br /> 88000 Закарпаття <br /> Україна <br /> Тел.: 00380/31/26 445 00<br /> Факс: 00380/31/26 445 00 <br /> E mail: office@tondach.biz<br /> <a href="http://www.tondach.biz">www.tondach.biz</a>, <a href="http://www.tondach.com">www.tondach.com</a></div>
</div>
...
Завод Nitrianske Pravno</div>
<div class="cols">
<div class="nums">3</div>
Офіс Bratislava</div>
<div class="cols">
<div class="nums">4</div>
Завод Gleinstätten</div>
<div class="cols">
<div class="nums">5</div>
Завод Unterpremstätten</div>
<div class="cols">
<div class="nums">6</div>
Завод Pinkafeld</div>
<div class="cols">
<div class="nums">7</div>
Завод Leobersdorf</div>
<div class="cols">
<div class="nums">8</div>
Склад Breitenschützing</div>
<div class="cols">
