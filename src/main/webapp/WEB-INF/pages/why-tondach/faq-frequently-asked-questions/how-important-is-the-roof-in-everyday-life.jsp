...
<t:indexpage>
    <title>  Наскільки важливим є дах в повсякденному житті? - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Наскільки важливим є дах в повсякденному житті?</li>
    </ul>
		
		<div id="content">
            <div class="imageTop">
              <div class="image">
                                <img src="${Constants.URL}media/1030/sessel-content-bild_content_big.png" alt="Наскільки важливим є дах в повсякденному житті?" width="684" height="200"/>
				  
				  </div>
            </div>
            <h1>
              Наскільки важливим є дах в повсякденному житті?
            </h1>
            <div>
				          

              <p style="text-align: justify;">Практично у всіх сферах, які стосуються ефективності використання енергії, а також якості життя мешканців, добре підібраний дах сприяє досягненню оптимальних результатів. Слід, наприклад, мати на увазі, що до 30% енергії, може втрачатися через дах. Водночас, дах також повинен бути в змозі витримувати екстремальні погодні умови, наприклад бурю, град, сніг. Скатні покрівлі з TONDACH® мають козирі у всіх цих областях. За відповідною ізоляцією і системними рішеннями TONDACH® досягається абсолютна герметичність з'єднань і проходів через покрівлю. Так втрати енергії зводяться до мінімуму. Технічна конструкція з масивних черепиці TONDACH® забезпечує оптимальний захист і безпеку в екстремальних погодних умовах – від хуртовини і дощових злив аж до штормів.<br />Також сьогодні дуже важливими є властивості комфорту. TONDACH® забезпечує теплозахист влітку, що призводить до меншої температури на горищі. А також у сильний дощ або град, жителі відчувають себе більш комфортно під TONDACH®, оскільки шуму набагато менше, ніж під дахом інших форм і матеріалів.</p>
            </div>
          </div>
</t:indexpage>