...
<t:indexpage>
    <title>  Кондиціювання повітря - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Кондиціювання повітря</li>
    </ul>
		...
		<div id="content">
            ...
            <div>
              ...
              <p style="text-align: justify;" dir="ltr"><span>Оптимальна комфортна температура на горищі є одним з найбільш важливіших завдань. У спекотне літо повітря під дахом повинно бути приємно прохолодним і в холодну зиму навпаки приємно теплим. Тому під зовнішньою захищаючою від дощу покрівлею з керамічної черепиці встановлюється сучасна теплоізоляція. Така ізоляція пізніше також може бути професійно виконана досвідченими майстрами.</span></p>
