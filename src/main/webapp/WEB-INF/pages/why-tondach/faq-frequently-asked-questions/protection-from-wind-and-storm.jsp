...
<t:indexpage>
    <title>  Захист від вітру і шторму - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li><a href="${Constants.URL}">Tondach</a></li>
        ...
        <li class="active">Захист від вітру і шторму</li>
    </ul>
		...
		<div id="content">
            ...
            <h1>
              Захист від вітру і шторму
            </h1>
            <div>
				          

              <p style="text-align: justify;" dir="ltr"><span>Захисна функція скатних дахів від вітру і шторму рідко кому знайома. Причина в тому, що скатні дахи могли витримати досить сильні бурі за рахунок використання технологій, кращих покрівельних матеріалів та висококваліфікованих покрівельників.</span></p>
