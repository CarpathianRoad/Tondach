...
<t:indexpage>
    <title>  Подальше добудова - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Подальше добудова</li>
    </ul>
		...
		<div id="content">
            ...
            <div>
              ...
              <p style="text-align: justify;" dir="ltr"><span>Сьогодні часто дахи в нових будівлях оздобленні та обладнанні всередині відразу. Тому що жити під дахом є не тільки популярним, але й економічно ефективним.</span></p>
<p style="text-align: justify;" dir="ltr"><span>Але якщо відсутній необхідний капітал, то пізніше добудова може бути здійснена не без проблем. З метою зниження витрат на будівництво, можлива подальша добудова в новій будівлі повинна бути вже врахована, наприклад, як за рахунок установки стандартизованої теплоізоляції так і достатньої кількості мансардних вікон для хорошого освітлення житлового простору. Також слід планувати заздалегідь підводку трубопроводів наприклад для подачі та відводу води. Поради в цій справі знають досвідчені покрівельники і проектувальники.</span></p>
