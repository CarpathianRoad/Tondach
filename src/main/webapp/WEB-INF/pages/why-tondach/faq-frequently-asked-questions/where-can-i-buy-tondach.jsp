...
<t:indexpage>
    <title>  Де я можу придбати TONDACH®? - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Де я можу придбати TONDACH&#174;?</li>
    </ul>
		
		<div id="content">
            <div class="imageTop">
              <div class="image">
                                <img src="${Constants.URL}media/1036/partner-content-bild_content_big.png" alt="Де я можу придбати TONDACH&#174;?" width="684" height="200"/>
				  
				  </div>
            </div>
            <h1>
              Де я можу придбати TONDACH&#174;?
            </h1>
            <div>
				          

                <p style="text-align: justify;">Нашу продукцію TONDACH® Ви можете знайти у наших авторизованих партнерів та покрівельників. Перелік авторизованих партнерів TONDACH® Ви знайдете в розділі Де придбати. <a href="${Constants.URL}where_buy/">Натисніть тут</a>. Ви можете зробити запит по регіону, так що Ви відразу ж знайдете справжніх професіоналів у Вашій околиці.<br />Звичайно, Ви також можете зв'язатися з нами безпосередньо, ми раді будемо порекомендувати одного з наших шановних TONDACH® професіоналів!</p>
            </div>
          </div>
</t:indexpage>