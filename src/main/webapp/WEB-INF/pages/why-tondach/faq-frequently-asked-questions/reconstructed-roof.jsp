...
<t:indexpage>
    <title>  Які ознаки вказують на необхідність реставрації даху? - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Які ознаки вказують на необхідність реставрації даху?</li>
    </ul>
		
		<div id="content">
            <div class="imageTop">
              <div class="image">
                                <img src="${Constants.URL}media/2019/roof-restor.png" alt="Які ознаки вказують на необхідність реставрації даху?" width="684" height="200"/>
				  
				  </div>
            </div>
            <h1>
              Які ознаки вказують на необхідність реставрації даху?
            </h1>
            <div>
				          

              <p dir="ltr"><span>Як може неспеціаліст виявити необхідність реставрації?</span></p>
<p dir="ltr"><span>Зовні:</span></p>
<p dir="ltr"><span>З допомогою бінокля можна помітити, чи послаблений покрівельний матеріал. Переконайтеся, чи не валяються на землі якісь частини будівельної конструкції або покрівельного матеріалу.</span></p>
<p dir="ltr"><span>Всередині:</span></p>
<p dir="ltr"><span>При відсутності нижньої покрівлі можна побачити на горищі промені світла. Проконтролюйте наявність гнилої обрешітки або крокв, а також  мокрих плям на нижній стороні даху від дощу.</span></p>
<p dir="ltr"><span>З нижньою покрівлею:</span></p>
<p dir="ltr"><span>У нижній частині звису даху можна побачити витікання води.</span></p>
<p dir="ltr"><span>Детальніший контроль:</span></p>
<p><span><span>Зверніться до професійної покрівельника або іншого фахівця.</span></span></p>
            </div>
          </div>
</t:indexpage>