...
<t:indexpage>
    <title>  На що повинен будівельник звертати особливу увагу при виборі покрівлі? - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">На що повинен будівельник звертати особливу увагу при виборі покрівлі?</li>
    </ul>
		...
		<div id="content">
            ...
            <h1>
              На що повинен будівельник звертати особливу увагу при виборі покрівлі?
            </h1>
            <div>
				          

              <p style="text-align: justify;">Перш за все важливим є принципове рішення: скатний або плоский дах? Хоча в даний час в моді більш прямолінійні та спрощенні форми даху, але слід пам'ятати, що похилий дах наприклад з кутом нахилу від 13 град в наших широтах виглядає природно сформованим. Тобто, ця форма даху вже довгий час використовується і так добре відома у нас, тому що це єдина форма, яка завдяки її нахилу уможливлює відвід дощової води і витримування важких снігових навантажень. Додаткові переваги полягають в функціональності та довговічності.</p>
            </div>
          </div> 
</t:indexpage>