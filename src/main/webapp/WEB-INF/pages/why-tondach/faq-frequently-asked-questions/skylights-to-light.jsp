...
<t:indexpage>
    <title>  Мансардні вікна для освітлення - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li><a href="${Constants.URL}why-tondach/faq-frequently-asked-questions/">FAQ - часті запитання</a></li>
            <li><a href="${Constants.URL}why-tondach/faq-frequently-asked-questions/benefits-of-pitched-roof/">Переваги скатного даху</a></li>

        
        <li class="active">Мансардні вікна для освітлення</li>
    </ul>
		...
		<div id="content">
            ...
            <h1>
              Мансардні вікна для освітлення
            </h1>
            <div>
				          

              <p style="text-align: justify;" dir="ltr"><span>Передумовою для здорового і комфортного життя під дахом є належна вентиляція та освітлення сонячними променями. Скатна покрівля має багато переваг. Раніше темні горища з допомогою систематичного монтажу мансардних вікон для їх жителів пропонують зовсім нову якість життя.</span></p>
<p style="text-align: justify;" dir="ltr"><span>На сьогоднішній день пропонується надзвичайно широкий вибір вікон різних комбінацій і розмірів. Ролети або жалюзі запобігають нагріву мансардних кімнат в жаркі і сонячні літні дні.</span></p>
<p style="text-align: justify;" dir="ltr"><span>Вибір і розташування вікон має важливе значення для оптимального освітлення внутрішнього простору. Воно включає в себе безперешкодний вид на вулицю і підходящу висоту установки, яка дозволяє безпроблемне відкривання та догляд. Із зовні мансардні вікна повинні підкреслити дизайн і стиль даху і не порушувати архітектуру даху. Тут може буде корисним хороший проектувальник з порадою і допомогою. Слухові вікна є більш традиційні елементи освітлення покрівельних просторів. Вони виразно переривають покрівлю і сильніше впливають на зовнішній вигляд даху. Крім того вони дають даху особливу, вимогливу нотку і здається всередині затишним і домашнім. Установка мансардних вікон повинна здебільшого плануватися наперед для нових  будівель, тому що подальша реконструкція представляє собою великі будівельні втручання, які повинні бути схвалені будівельним адміністративним органом і відповідно це спричиняє високі матеріальні затрати.</span></p>
<p style="text-align: justify;" dir="ltr"> </p>
<p><span class="read-more"><a href="${Constants.URL}why-tondach/faq-frequently-asked-questions/benefits-of-pitched-roof/" class="more">« Назад</a></span></p>
            </div>
          </div>
</t:indexpage>