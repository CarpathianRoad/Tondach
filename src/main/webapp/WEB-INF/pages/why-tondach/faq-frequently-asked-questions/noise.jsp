...
<t:indexpage>
    <title>  Захист від шуму - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Захист від шуму</li>
    </ul>
		...
		<div id="content">
            ...
            <div>
              ...
              <p style="text-align: justify;" dir="ltr"><span>Шумоізоляція поряд з теплоізоляцією та захистом від вологи є на першому місці серед будівельних заходів, що створюють хороший мікроклімат в приміщенні. Так як до комфорту належить також акустично спокійна атмосфера – не тільки зовні всередину, але і навпаки.</span></p>
<p style="text-align: justify;" dir="ltr"><span>При звичайній добудові горища може бути досягнута відмінна звукоізоляція з невеликими затратами. Оптимальний захист від шуму тут досягається завдяки покрівельному матеріалу, але перш за все з допомогою належної внутрішньої обшивки.</span></p>
<p style="text-align: justify;" dir="ltr"><span>Важливе значення для звукоізоляції поряд з вагою має перш за все герметичність з’єднань конструкції даху. Чим важча конструкція і чим менша кількість з’єднань, тим вищий рівень звукоізоляції.</span></p>
<p style="text-align: justify;"><span><span>У місцях з високим рівнем шуму, наприклад аеропорти, може бути досягнутий вищий рівень шумоізоляції завдяки зміцненню внутрішньої конструкції, наприклад з допомогою настилу товщиною 22-24 мм на верхній стороні стропил. Ще додає звукоізоляції відповідна внутрішня обшивка. Досвідчений покрівельник також порадить оптимальну звукоізоляцію.</span></span></p>
