...
<t:indexpage>
    <title>  Який термін служби TONDACH®? - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Який термін служби TONDACH&#174;?</li>
    </ul>
		
		<div id="content">
            <div class="imageTop">
              <div class="image">
                                <img src="${Constants.URL}media/1035/wetter-content-bild_content_big.png" alt="Який термін служби TONDACH&#174;?" width="684" height="200"/>
				  
				  </div>
            </div>
            <h1>
              Який термін служби TONDACH&#174;?
            </h1>
            <div>
				          

              <p style="text-align: justify;">Лідируючі позиції серед покрівельних матеріалів займає TONDACH® завдяки фактично підтвердженому терміну служби більше ста років. Черепиця TONDACH® не тільки міцна, але й економічна, так як вирішальним критерієм для оцінки матеріалу покрівлі є довговічність, а не вартість в момент придбання!!!<br />Справжня «економічність» матеріалу визначається тоді, коли забудовнику не доводиться витрачати додатково кошти на різного типу ремонтні роботи. Це особливо стосується даху будинків, для яких конструкція і покриття є лише частиною витрат на будівництво.<br />Важливо те, що TONDACH® є дешевшим в довгостроковій перспективі, тому що відновлення даху потрібне тільки через більш ніж 100 років, тому гарантія TONDACH® надається строком на 33 роки для кожного продукту. Докладнішу інформацію знайдете в розділі <a href="${Constants.URL}why-tondach/33-year-warranty">33 роки гарантії</a>.</p>
            </div>
          </div
</t:indexpage>