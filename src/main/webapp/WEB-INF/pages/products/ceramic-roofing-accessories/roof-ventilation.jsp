...
<t:indexpage>
    <title>  Вентиляція даху - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Вентиляція даху</li>
    </ul>
...
<div class="subline">Вентиляційні черепиці TONDACH<sup>®</sup> дають можливість вашому даху дихати і запобігають пошкодженню через вологу і зростанню цвілі.</div>
...
<a>Вентиляційна та підгребенева черепиця</a></li>
</ul>
</div>
            </div>
          </div>
