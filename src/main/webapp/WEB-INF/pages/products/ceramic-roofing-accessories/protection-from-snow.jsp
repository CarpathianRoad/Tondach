...
<t:indexpage>
    <title>  Захист від снігу - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Захист від снігу</li>
    </ul>
...
<div class="subline"><span><span>Снігозатримуючі черепиці TONDACH<sup>®</sup> запобігають неконтрольований зсув снігу та візуально гарно вписуються у загальний вигляд покрівлі.</span></span></div>
