...
<t:indexpage>
    <title>  Граніце-11 - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1671/granice11.png" title="Граніце-11">
                    <img title="Граніце-11" alt="Граніце-11" src="${Constants.URL}media/1671/granice11.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2006/granice11_13.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2005/granice11_10.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2004/granice11_00.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2007/granice11_40.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2008/granice11_70.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2009/granice11_71.jpg" alt="Граніце-11" title="Граніце-11" /><span id="color_properties"></span></div>
...
<li>Граніце 11 наділена популярною формою і зручна у монтажі, оскільки має варіативну довжину поверхні.  </li>
<li>Керамічна черепиця Граніце 11 - великоформатна черепиця, що перебуває у гармонії з навколишнім середовищем. </li>
<li>Цікавий зовнішній вигляд та використання глазурі "Амадеус" надає замовнику можливість покрити дах свого будинку, втіливши в життя найсміливіші архітектурні рішення.</li>
</ul>
...
<tr>
<td>Кількість мін.</td>
<td><span>10,8 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>34 - 40 см</span></td>
</tr>
</tbody>
</table>
...
<td>20°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1684/granice11-pattern.jpg" alt="Граніце-11" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1754/бокова-ліва.jpg" alt="Граніце-11" title="Граніце-11" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1755/бокова-права.jpg" alt="Граніце-11" title="Граніце-11" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1756/половинчаста.jpg" alt="Граніце-11" title="Граніце-11" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2112/вентиляційна.jpg" alt="Граніце-11" title="Граніце-11" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1839/граніце1.jpg" alt="Граніце-11" title="Граніце-11" />
            <img src="${Constants.URL}media/1840/граніце3.jpg" alt="Граніце-11" title="Граніце-11" />
            <img src="${Constants.URL}media/1842/граніце4.jpg" alt="Граніце-11" title="Граніце-11" />
            <img src="${Constants.URL}media/1841/гранціе2.jpg" alt="Граніце-11" title="Граніце-11" />
            <img src="${Constants.URL}media/1843/schloss-hranice.jpg" alt="Граніце-11" title="Граніце-11" />
            <img src="${Constants.URL}media/1844/граніце6.jpg" alt="Граніце-11" title="Граніце-11" />
 </div> 
		</div> 
