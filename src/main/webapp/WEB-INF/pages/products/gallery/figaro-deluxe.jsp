...
<t:indexpage>
    <title>  Фігаро Делюкс - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li class="active">Фігаро Делюкс</li>
    </ul>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1677/15-2-figaro-deluxe.png" title="Фігаро Делюкс">
                    <img title="Фігаро Делюкс" alt="Фігаро Делюкс" src="${Constants.URL}media/1677/15-2-figaro-deluxe.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1973/figaro_00.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1974/figaro_10.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1975/figaro_12.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1978/figaro_33.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1977/figaro_19.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1976/figaro_13.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1979/figaro_40.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1980/figaro_41.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span id="color_properties"></span></div>
...
<tr>
<td>Повна довжина</td>
<td><span>42,4 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>24,1 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>35,1 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>21,1 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>3,2 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>13,5 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>32,3 - 35,1 см</span></td>
</tr>
</tbody>
</table>
...
<p> </p>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1690/6.png" alt="Фігаро Делюкс" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2117/половинна.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2118/бокова-права.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2119/бокова-ліва.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2120/вентиляційна.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2124/пластина-бокова-права.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2123/пластина-бокова-ліва.png" alt="Фігаро Делюкс" title="Фігаро Делюкс" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1803/8.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" />
            <img src="${Constants.URL}media/1802/7.jpg" alt="Фігаро Делюкс" title="Фігаро Делюкс" />
 </div> 
		</div>
