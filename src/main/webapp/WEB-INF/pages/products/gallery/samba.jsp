...
<t:indexpage>
    <title>  Самба - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1643/samba.png" title="Самба">
                    <img title="Самба" alt="Самба" src="${Constants.URL}media/1643/samba.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1663/samba_00.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1664/samba_10.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1665/samba_13.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1668/samba_71.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1667/samba_40.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1666/samba_43.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1669/samba_70.jpg" alt="Самба" title="Самба" /><span id="color_properties"></span></div>
...
<li>Великоформатна посувна черепиця з популярним профілем.  </li>
<li>Можливість змін кроку обрешітки полегшує монтаж, економить пиломатеріали та зменшує кількість відходів черепиці.</li>
...
<td><span>22,8 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>3,7 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>11,5 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>35,5 - 38,0 см</span></td>
</tr>
</tbody>
</table>
...
<td>12°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1644/samba-pattern.jpg" alt="Самба" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2110/вентиляційна.jpg" alt="Самба" title="Самба" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1646/бокова-ліва.jpg" alt="Самба" title="Самба" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1647/бокова-права.jpg" alt="Самба" title="Самба" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1650/підгребенева.jpg" alt="Самба" title="Самба" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1649/підгребенева-бокова-права.jpg" alt="Самба" title="Самба" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1648/підгребенева-бокова-ліва.jpg" alt="Самба" title="Самба" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1651/1.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1652/2.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1653/3.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1654/12.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1655/13.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1656/14.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1657/16.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1658/17.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1660/samba_gal2_big.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1659/samba_eng_cervena__1_.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1662/samba_gal6_.jpg" alt="Самба" title="Самба" />
            <img src="${Constants.URL}media/1661/samba_gal4_.jpg" alt="Самба" title="Самба" />
 </div> 
		</div> 
		<!-- "next page" action --> 
