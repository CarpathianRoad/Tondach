...
<t:indexpage>
    <title>  Кармен - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1679/karmen.png" title="Кармен">
                    <img title="Кармен" alt="Кармен" src="${Constants.URL}media/1679/karmen.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1963/karmen_48.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1962/karmen_41.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1961/karmen_40.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1958/karmen_13.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1959/karmen_19.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1960/karmen_33.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1957/karmen_12.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1956/karmen_10.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1955/karmen_00.jpg" alt="Кармен" title="Кармен" /><span id="color_properties"></span></div>
...
<li>Даний вид черепиці підходить для будівель з мінімальним кутом нахилу схилу від 13°.</li>
<li>Широка гама цікавих кольорових поверхневих  обробок.</li>
<li>Глибокі головні та бокові ринви відводять воду та захищають дах від впливу вітру.</li>
</ul>
...
<tr>
<td>Повна довжина</td>
<td><span>45,5 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>27,0 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>37,2 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>21,8 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>4,0 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>12,3 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>35,8 - 37,2 см</span></td>
</tr>
</tbody>
</table>
...
<td>12°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1692/karmen_patt.jpg" alt="Кармен" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1763/бокова-ліва.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1764/бокова-права.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1765/вентиляційна.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1768/підгребенева.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1767/підгребенева-бокова-права.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1766/підгребенева-бокова-ліва.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1770/снігозахисна.jpg" alt="Кармен" title="Кармен" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1786/2.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1787/12.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1789/ref14-6-carmen-naturrot_16_big.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1788/11.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1790/ref48-1-carmen-e-sand-antik_big.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1791/ref162-5-carmen-naturrot_9_big.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1792/ref195-1-carmen-naturrot_7_big.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1793/ref167-1-carmen-e-scharz_big.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1795/ref14_4___carmen_naturrot.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1794/3.jpg" alt="Кармен" title="Кармен" />
            <img src="${Constants.URL}media/1796/1.jpg" alt="Кармен" title="Кармен" />
 </div> 
		</div>
