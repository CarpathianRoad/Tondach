...
<t:indexpage>
    <title>  Медитеран Плюс - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Медитеран Плюс</li>
    </ul>

<div class="content" id="galery-item">
    <div class="product-detail">
        <h1>Медитеран Плюс</h1>
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/2070/00_натур.png" title="Медитеран Плюс">
                    <img title="Медитеран Плюс" alt="Медитеран Плюс" src="${Constants.URL}media/2070/00_натур.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2071/mediteran-plus_00.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2072/mediteran-plus_10.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2073/mediteran-plus_12.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2074/mediteran-plus_13.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2075/mediteran-plus_19.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2076/mediteran-plus_31.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2077/mediteran-plus_33.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2078/mediteran-plus_40.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2079/mediteran-plus_41.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2080/mediteran-plus_48.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2081/mediteran-plus_53.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2082/mediteran-plus_54.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span id="color_properties"></span></div>
...
<li>Черепиця Медитеран Плюс надає Вашому будинку середземноморського стилю.</li>
<li>Форма даної черепиці дозволяє втільвати в життя різні форми покрівлі.</li>
...
<td>12°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/2052/покрівля.jpg" alt="Медитеран Плюс" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2095/підгребенева-бокова-ліва.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2096/підгребенева-бокова-права.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2097/підгребенева.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2098/бокова-ліва.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2099/бокова-права.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2100/вентиляційна.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2101/пластина-бокова-права.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2102/пластина-бокова-ліва.png" alt="Медитеран Плюс" title="Медитеран Плюс" /><span></span></div>
            ...
            <img src="${Constants.URL}media/2054/1.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" />
            <img src="${Constants.URL}media/2055/2.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" />
            <img src="${Constants.URL}media/2056/3.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" />
            <img src="${Constants.URL}media/2057/4.jpg" alt="Медитеран Плюс" title="Медитеран Плюс" />
 </div> 
		</div> 
		<!-- "next page" action --> 
