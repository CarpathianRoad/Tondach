...
<t:indexpage>
    <title>  Медитеран - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1432/mediteran.png" title="Медитеран">
                    <img title="Медитеран" alt="Медитеран" src="${Constants.URL}media/1432/mediteran.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1887/mediteran_48.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1889/mediteran_19.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1891/mediteran_54.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1890/mediteran_53.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1892/mediteran_81.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1888/mediteran_52.jpg" alt="Медитеран" title="Медитеран" /><span id="color_properties"></span></div>
...
<li>Черепиця Медитеран надає Вашому будинку середземноморського стилю.</li>
...
<td>12°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1476/mediteran-pattern.jpg" alt="Медитеран" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2104/бокова-ліва.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1467/бокова-права.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1470/підгребенева.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1469/підгребенева-бокова-права.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2103/підгребенева-бокова-ліва.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1466/вентиляційна.jpg" alt="Медитеран" title="Медитеран" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1450/1.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1451/2.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1452/4.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1453/3.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1454/5.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1455/6.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1458/dsc08761_big.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1456/7.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1457/8.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1459/dsc08771_big.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1460/dsc09101.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1461/mediteran-plus-e-sand-antik_big.jpg" alt="Медитеран" title="Медитеран" />
            <img src="${Constants.URL}media/1463/10.jpg" alt="Медитеран" title="Медитеран" />
 </div> 
		</div> 
		<!-- "next page" action --> 
