...
<t:indexpage>
    <title>  Венера - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1674/venera.png" title="Венера">
                    <img title="Венера" alt="Венера" src="${Constants.URL}media/1674/venera.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1990/venus_00.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1991/venus_11.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1992/venus_19.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1995/venus_71.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1994/venus_48.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1993/venus_33.jpg" alt="Венера" title="Венера" /><span id="color_properties"></span></div>
...
<li>Черепиця Венера зручна у монтажі та в експлуатації. Використання новітніх технологій забезпечує довговічність керамічної черепиці. </li>
<li>Візуальна привабливітсь черепиці Венера дозволяє втілити в життя поєднання дизайну та якості.</li>
</ul>
...
<tr>
<td>Повна довжина</td>
<td><span>48,0 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>29,0 см</span></td>
</tr>
<tr>
...
<td>10°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1687/фото-криши.jpg" alt="Венера" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1737/бокова-ліва.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1738/бокова-права.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1739/карнизна.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1742/підгребенева-бокова-права.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1741/підгребенева-бокова-ліва.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1740/ліва-канизна.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1743/підгребенева.jpg" alt="Венера" title="Венера" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1744/права-карнизна.jpg" alt="Венера" title="Венера" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1816/венера2.jpg" alt="Венера" title="Венера" />
            <img src="${Constants.URL}media/1817/венера1.jpg" alt="Венера" title="Венера" />
            <img src="${Constants.URL}media/1819/венера4.jpg" alt="Венера" title="Венера" />
            <img src="${Constants.URL}media/1818/1.jpg" alt="Венера" title="Венера" />
            <img src="${Constants.URL}media/1820/фото-дом.jpg" alt="Венера" title="Венера" />
            <img src="${Constants.URL}media/1821/венера3.jpg" alt="Венера" title="Венера" />
 </div> 
		</div>
