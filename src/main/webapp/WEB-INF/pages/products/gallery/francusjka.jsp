...
<t:indexpage>
    <title>  Французька - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1672/francuzka.png" title="Французька">
                    <img title="Французька" alt="Французька" src="${Constants.URL}media/1672/francuzka.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1998/francuzka_00.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1999/francuzka_10.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2000/francuzka_13.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2003/francuzka_71.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2002/francuzka_70.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/2001/francuzka_40.jpg" alt="Французька" title="Французька" /><span id="color_properties"></span></div>
...
<li>Керамічна черепиця придатна для різних видів будівель.</li>
<li>Глибокі водовідвідні жолоби дають можливість використання даного виду черепиці на покрівлі з  кутом нахилу схилу від 20°.</li>
<li>Французька черепиця пропонує цікаві види поверхневої обробки.</li>
</ul>
...
<tr>
<td>Повна ширина</td>
<td><span>27,7 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>38,5 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>23,2 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>3,6 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>11,3 шт/м²</span></td>
</tr>
<tr>
...
<td>20°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1685/francuzka-pattern.jpg" alt="Французька" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2113/бокова-ліва.jpg" alt="Французька" title="Французька" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2114/бокова-права.jpg" alt="Французька" title="Французька" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2115/пловинна.jpg" alt="Французька" title="Французька" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2116/вентиляційна.jpg" alt="Французька" title="Французька" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1828/2.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1829/1.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1831/3.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1830/fr12-amadeus-cerna_skacel-j_36_03_1_big.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1832/4.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1833/fr12_velikovsky_025_08_kopie.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1835/fr12-rezna_-pustka-m_37_17_1_big.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1834/francouzska_14_eng_antracit_big.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1837/francuzska_rd_e1_hneda_cz-05_big.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1836/francuzska14_hs_pr__roznava_04.jpg" alt="Французька" title="Французька" />
            <img src="${Constants.URL}media/1838/francuzska_rd_e1_hneda_cz-06_big.jpg" alt="Французька" title="Французька" />
 </div> 
		</div> 
