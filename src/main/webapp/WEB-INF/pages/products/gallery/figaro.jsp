...
<t:indexpage>
    <title>  Фігаро - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1676/figaro.png" title="Фігаро">
                    <img title="Фігаро" alt="Фігаро" src="${Constants.URL}media/1676/figaro.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1981/figaro_00.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1982/figaro_10.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1983/figaro_12.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1986/figaro_33.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1985/figaro_19.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1984/figaro_13.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1987/figaro_40.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1988/figaro_41.jpg" alt="Фігаро" title="Фігаро" /><span id="color_properties"></span></div>
...
<li>Сучасна проста форма приверне увагу кожного замовника та забудовника. </li>
<li>Гладка поверхнева обробка надає покрівлі бездоганного вигляду.</li>
<li>Невисока витратність матеріалу полегшує покриття даху.</li>
</ul>
...
<td><span>37,0 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>23,3 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>4,3 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>11,6 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>33,5 - 37,0 см</span></td>
</tr>
</tbody>
</table>
...
<p> </p>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1689/figaro-pattern.jpg" alt="Фігаро" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1724/бокова-ліва.jpg" alt="Фігаро" title="Фігаро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1725/бокова-права.jpg" alt="Фігаро" title="Фігаро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1726/вентиляційна.jpg" alt="Фігаро" title="Фігаро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1728/половинна.jpg" alt="Фігаро" title="Фігаро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1727/снігозахисна.jpg" alt="Фігаро" title="Фігаро" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1804/figaro_big.jpg" alt="Фігаро" title="Фігаро" />
            <img src="${Constants.URL}media/1805/figaro1_big.jpg" alt="Фігаро" title="Фігаро" />
            <img src="${Constants.URL}media/1807/figaro3_big.jpg" alt="Фігаро" title="Фігаро" />
            <img src="${Constants.URL}media/1806/figaro2_big.jpg" alt="Фігаро" title="Фігаро" />
            <img src="${Constants.URL}media/1808/ref216_1___fidelio_e_antik.jpg" alt="Фігаро" title="Фігаро" />
            <img src="${Constants.URL}media/1809/ref204_2___figaro_e_antik.jpg" alt="Фігаро" title="Фігаро" />
 </div> 
		</div> 
