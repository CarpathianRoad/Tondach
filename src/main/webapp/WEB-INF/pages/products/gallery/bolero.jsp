...
<t:indexpage>
    <title>  Болеро - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1540/bolero.jpg" title="Болеро">
                    <img title="Болеро" alt="Болеро" src="${Constants.URL}media/1540/bolero.jpg">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1549/bolero_12.jpg" alt="Болеро" title="Болеро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1550/bolero_10.jpg" alt="Болеро" title="Болеро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1551/bolero_40.jpg" alt="Болеро" title="Болеро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1553/bolero_81.jpg" alt="Болеро" title="Болеро" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1552/bolero_43.jpg" alt="Болеро" title="Болеро" /><span id="color_properties"></span></div>
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
                                        ...
                                        <ul>
<li>Плавні контури черепиці Болеро підкреслять переваги сучасної архітектурної  споруди.</li>
<li>Велична простота в сучасному стилі будівництва.</li>
<li>Ретельний підбір сировини і високотехнологічний спосіб обробки гарантують максимальну механічну тривкість та оптимальну вагу покрівлі.</li>
</ul>
...
<td>15°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1541/болеро-дах.jpg" alt="Болеро" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1542/бокова-ліва.jpg" alt="Болеро" title="Болеро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1543/вентиляційна.jpg" alt="Болеро" title="Болеро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1545/снігозахисна.jpg" alt="Болеро" title="Болеро" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1544/бокова-права.jpg" alt="Болеро" title="Болеро" /><span></span></div>
            ...
            <img src="${Constants.URL}media/2017/болеро2.jpg" alt="Болеро" title="Болеро" />
            <img src="${Constants.URL}media/2016/болеро1.jpg" alt="Болеро" title="Болеро" />
            <img src="${Constants.URL}media/2018/болеро3.jpg" alt="Болеро" title="Болеро" />
 </div> 
		</div> 
		<!-- "next page" action --> 
