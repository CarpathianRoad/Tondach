...
<t:indexpage>
    <title>  Фіделіо - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1678/fidelio.png" title="Фіделіо">
                    <img title="Фіделіо" alt="Фіделіо" src="${Constants.URL}media/1678/fidelio.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1964/fidelio_00.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1965/fidelio_10.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1966/fidelio_12.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1969/fidelio_33.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1968/fidelio_19.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1967/fidelio_13.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1970/fidelio_40.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1971/fidelio_41.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1972/fidelio_48.jpg" alt="Фіделіо" title="Фіделіо" /><span id="color_properties"></span></div>
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
                                        ...
                                        <ul>
<li>Глибокі водовідвідні жолоби надають можливість використовувати даний вид черепиці на даху з кутом нахилу схилів від 20°.</li>
<li>Класична керамічна черепиця, що підходить для різних видів будівель.</li>
<li>Цікава кольорова гама.</li>
</ul>
...
<td><span>39,5 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>23,0 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>4,2 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>11,0 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>35,5 - 39,5 см</span></td>
</tr>
</tbody>
</table>
...
<td>20°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1691/fidelio_pattern.jpg" alt="Фіделіо" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1715/бокова-ліва.jpg" alt="Фіделіо" title="Фіделіо" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1716/бокова-права.jpg" alt="Фіделіо" title="Фіделіо" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1717/вентиляційна.jpg" alt="Фіделіо" title="Фіделіо" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1719/снігозахисна.jpg" alt="Фіделіо" title="Фіделіо" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1718/половинна.jpg" alt="Фіделіо" title="Фіделіо" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1797/ref_fidelio-nr_big.jpg" alt="Фіделіо" title="Фіделіо" />
            <img src="${Constants.URL}media/1798/фіделіо1.jpg" alt="Фіделіо" title="Фіделіо" />
            <img src="${Constants.URL}media/1800/ref_fidelio_big.jpg" alt="Фіделіо" title="Фіделіо" />
            <img src="${Constants.URL}media/1799/ref216_1___fidelio_e_antik.jpg" alt="Фіделіо" title="Фіделіо" />
            <img src="${Constants.URL}media/1801/фіделіо2.jpg" alt="Фіделіо" title="Фіделіо" />
 </div> 
		</div> 
