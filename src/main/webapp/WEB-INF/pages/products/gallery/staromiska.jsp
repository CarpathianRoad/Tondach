...
<t:indexpage>
    <title>  Староміська - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li class="active">Староміська</li>
    </ul>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1675/ukr-5.jpg" title="Староміська">
                    <img title="Староміська" alt="Староміська" src="${Constants.URL}media/1675/ukr-5.jpg">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1989/staromisk_00.jpg" alt="Староміська" title="Староміська" /><span id="color_properties"></span></div>
            ...
            <div class="col-xs-12">
                <div class="tech tabs"  style="margin-left: 10px;">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#roof" data-toggle="tab">Покрівля</a></li>
                    </ul>
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
                                        ...
                                        <ul>
<li>Обпечена глина відома людству з давніх-давен як один з найміцніших та водночас найпривабливіших матеріалів.</li>
<li>Під час виробництва Староміської кладки застосовується спеціальна технологія, що створює структуровану черепицю.</li>
<li>Для Староміської черепиці розроблені спеціальні комплектуючя зі структурованою поверхнею, такі, як підгребенева черепиця, карнизна, вентиляційний комплект.</li>
</ul>
...
<tr>
<td>Повна ширина</td>
<td><span>19 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>15 см</span></td>
</tr>
<tr>
...
<p> </p>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1688/katalog-emiliaxx.jpg" alt="Староміська" rel="2685" /></p>
            ...
            <img src="${Constants.URL}media/1810/староміська2.jpg" alt="Староміська" title="Староміська" />
            <img src="${Constants.URL}media/1811/староміська1.jpg" alt="Староміська" title="Староміська" />
            <img src="${Constants.URL}media/1813/staromestsky_ba_01.jpg" alt="Староміська" title="Староміська" />
            <img src="${Constants.URL}media/1812/староміська3.jpg" alt="Староміська" title="Староміська" />
            <img src="${Constants.URL}media/1814/староміська5.jpg" alt="Староміська" title="Староміська" />
            <img src="${Constants.URL}media/1815/cтароміська4.jpg" alt="Староміська" title="Староміська" />
 </div> 
		</div>
