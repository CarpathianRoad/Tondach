...
<t:indexpage>
    <title>  Твіст - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1441/twist.png" title="Твіст">
                    <img title="Твіст" alt="Твіст" src="${Constants.URL}media/1441/twist.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1472/twist_11.jpg" alt="Твіст" title="Твіст" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1471/twist_12.jpg" alt="Твіст" title="Твіст" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1473/twist_40.jpg" alt="Твіст" title="Твіст" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1475/twist_81.jpg" alt="Твіст" title="Твіст" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1474/twist_43.jpg" alt="Твіст" title="Твіст" /><span id="color_properties"></span></div>
...
<li>Керамічна черепиця, що підходить не тільки для нових будівель, а й для реконструкції старих. </li>
<li>Керамічна черепиця Твіст завдяки великому формату економить роботу покрівельника, надає можливість більш простої укладки черепиці та економить пиломатеріали. </li>
<li>Завдяки сучасним технологіям, що застосовуються на заводах концерну Tondach, дана черепиця є високотехнологічним продуктом, що наділений найкращими якостями та властивостями.</li>
</ul>
...
<tr>
<td><span>З водонепроникною гідроізоляцією</span></td>
<td>15°</td>
</tr>
</tbody>
</table>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1464/twist-pattern.jpg" alt="Твіст" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/2105/бокова-ліва.jpg" alt="Твіст" title="Твіст" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1496/бокова-права.jpg" alt="Твіст" title="Твіст" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1497/половинна.jpg" alt="Твіст" title="Твіст" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1499/снігозахисна.jpg" alt="Твіст" title="Твіст" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1498/вентиляційна.jpg" alt="Твіст" title="Твіст" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1478/2.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1477/1.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1480/12.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1479/11.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1481/3.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1482/13.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1485/16-1.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1483/15.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1484/14.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1487/16.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1486/4.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1488/ref-twist-e-antik_big.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1490/твіст2.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1492/tvist_big.jpg" alt="Твіст" title="Твіст" />
            <img src="${Constants.URL}media/1493/5.jpg" alt="Твіст" title="Твіст" />
 </div> 
		</div> 
		<!-- "next page" action --> 
