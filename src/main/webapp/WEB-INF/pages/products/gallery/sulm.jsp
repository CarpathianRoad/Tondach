...
<t:indexpage>
    <title>  Сульм - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1682/sulm.png" title="Сульм">
                    <img title="Сульм" alt="Сульм" src="${Constants.URL}media/1682/sulm.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1893/sulm_00.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1894/sulm_10.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1895/sulm_12.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1898/sulm_21.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1897/sulm_19.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1896/sulm_13.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1899/sulm_22.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1900/sulm_23.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1901/sulm_24.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1904/sulm_33.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1903/sulm_32.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1902/sulm_31.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1905/sulm_34.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1906/sulm_36.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1907/sulm_40.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1910/sulm_70.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1909/sulm_48.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1908/sulm_41.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1911/sulm_71.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1912/sulm_72.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1913/sulm_73.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1914/sulm_85.jpg" alt="Сульм" title="Сульм" /><span id="color_properties"></span></div>
...
<li>Глибокі головні та бокові ринви захищають дах від  впливу погодніх умов.</li>
<li>Можливість пересування черепиці більш ніж на 3 см полегшує роботу при монтажі, економить матеріали.</li>
</ul>
...
<tr>
<td>Повна довжина</td>
<td><span>42,2 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>25,2 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>33,6 см</span></td>
</tr>
<tr>
<td>Ширина покриття</td>
<td><span>20,0 см</span></td>
</tr>
<tr>
<td>Вага</td>
<td><span>3,0 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>14,9 шт/м²</span></td>
</tr>
<tr>
<td>Крок обрешітки</td>
<td><span>30,6 - 33,6 см</span></td>
</tr>
</tbody>
</table>
...
<td>15°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1695/sulm-pattern.jpg" alt="Сульм" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1697/бокова-ліва.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1698/бокова-права.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1701/підгребенева-бокова-права.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1700/підгребенева-бокова-ліва.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1699/вентиляційна.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1702/підгребенева.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1703/снігозахисна.jpg" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2125/пластина-бокова-ліва.png" alt="Сульм" title="Сульм" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2126/пластина-бокова-права.png" alt="Сульм" title="Сульм" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1771/ref6-3-sulm-g-achatgrau_big.jpg" alt="Сульм" title="Сульм" />
            <img src="${Constants.URL}media/1772/ref136-1-sulm-vz-e-sand-antik_29_big.jpg" alt="Сульм" title="Сульм" />
            <img src="${Constants.URL}media/1774/ref165-1-sulm-g-dunkelblau_big.jpg" alt="Сульм" title="Сульм" />
            <img src="${Constants.URL}media/1773/ref129-2-sulm-g-dunkelblau_2_big.jpg" alt="Сульм" title="Сульм" />
            <img src="${Constants.URL}media/1775/ref113-1-sulm-e-antik_big.jpg" alt="Сульм" title="Сульм" />
            <img src="${Constants.URL}media/1776/ref128-1-sulm-a-natur_big.jpg" alt="Сульм" title="Сульм" />
 </div> 
		</div>
