...
<t:indexpage>
    <title>  Празький прейз - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li class="active">Празький прейз</li>
    </ul>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1673/prazkij-prejz.png" title="Празький прейз">
                    <img title="Празький прейз" alt="Празький прейз" src="${Constants.URL}media/1673/prazkij-prejz.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1997/prazkij-prejz_19.jpg" alt="Празький прейз" title="Празький прейз" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1996/prazkij-prejz_00.jpg" alt="Празький прейз" title="Празький прейз" /><span id="color_properties"></span></div>
...
<li>Старовинна форма черепиці ідеальна для створення вишуканих форм покрівлі. </li>
<li>Такий тип черепиці потребує неабиякої майстерності від покрівельника. </li>
</ul>
...
<tr>
<td>Повна довжина</td>
<td><span>43,0 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>14,2 см</span></td>
</tr>
<tr>
<td>Довжина покриття</td>
<td><span>35,0 см</span></td>
</tr>
<tr>
...
<tr>
<td>Вага</td>
<td><span>2,8 кг/шт</span></td>
</tr>
<tr>
<td>Кількість мін.</td>
<td><span>12,0 шт/м²</span></td>
</tr>
<tr>
...
<td>°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1686/prazkij-prejz-pattern.jpg" alt="Празький прейз" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1745/великий-нижній.jpg" alt="Празький прейз" title="Празький прейз" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1746/великий-верхній.jpg" alt="Празький прейз" title="Празький прейз" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1747/малий-верхній.jpg" alt="Празький прейз" title="Празький прейз" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1748/малий-нижній.jpg" alt="Празький прейз" title="Празький прейз" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1822/praha_big.jpg" alt="Празький прейз" title="Празький прейз" />
            <img src="${Constants.URL}media/1823/preiz_big.jpg" alt="Празький прейз" title="Празький прейз" />
            <img src="${Constants.URL}media/1826/21_prejz.jpg" alt="Празький прейз" title="Празький прейз" />
            <img src="${Constants.URL}media/1825/prejz_hs_pr_cz_04.jpg" alt="Празький прейз" title="Празький прейз" />
            <img src="${Constants.URL}media/1824/prejz_hs_pr_cz_01.jpg" alt="Празький прейз" title="Празький прейз" />
            <img src="${Constants.URL}media/1827/28_prejz_funst_palac.jpg" alt="Празький прейз" title="Празький прейз" />
 </div> 
		</div>
