...
<t:indexpage>
    <title>  Мульде - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1680/mulde.png" title="Мульде">
                    <img title="Мульде" alt="Мульде" src="${Constants.URL}media/1680/mulde.png">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1934/mulde_00.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1935/mulde_10.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1936/mulde_12.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1939/mulde_21.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1938/mulde_19.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1937/mulde_13.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1940/mulde_22.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1941/mulde_23.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1942/mulde_24.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1945/mulde_33.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1944/mulde_32.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1943/mulde_31.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1946/mulde_34.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1947/mulde_36.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1948/mulde_40.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1951/mulde_71.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1950/mulde_70.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1949/mulde_41.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1952/mulde_72.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1953/mulde_73.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1954/mulde_85.jpg" alt="Мульде" title="Мульде" /><span id="color_properties"></span></div>
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
                                        ...
                                        <div class="cancol col1t3">
<div class="content short_text_val">
<ul id="features" class="marked">
<li>Принадна форма черепиці створює прості лінії на покрівлі. </li>
<li>Можливість пересування черепиці більше ніж на 6 см полегшує роботу при монтажі, економить пиломатеріал. </li>
</ul>
</div>
</div>
...
<tr>
<td>Повна довжина</td>
<td><span>40,5 см</span></td>
</tr>
<tr>
<td>Повна ширина</td>
<td><span>24,0 см</span></td>
</tr>
<tr>
...
<td>20°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1693/mulde-pattern.jpg" alt="Мульде" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1710/бокова-ліва.jpg" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1711/бокова-права.jpg" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1714/снігозахисна.jpg" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1713/половинна.jpg" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1712/вентиляційна.jpg" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2121/пластина-бокова-ліва.png" alt="Мульде" title="Мульде" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/2122/пластина-бокова-права.png" alt="Мульде" title="Мульде" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1781/mulde_vz_e_schwarz.jpg" alt="Мульде" title="Мульде" />
            <img src="${Constants.URL}media/1782/ref114-1-mulde-vz-e-antik_big.jpg" alt="Мульде" title="Мульде" />
            <img src="${Constants.URL}media/1783/ref115-1-mulde-vz-e-antik_big.jpg" alt="Мульде" title="Мульде" />
            <img src="${Constants.URL}media/1784/ref52-1-mulde-vz-a-rot_1_big.jpg" alt="Мульде" title="Мульде" />
            <img src="${Constants.URL}media/1785/mulde-vz_big.jpg" alt="Мульде" title="Мульде" />
 </div> 
		</div>
