...
<t:indexpage>
    <title>  Віденська - природньо красиві і довговічні покрівлі </title>
    ...
    <div class="product-detail">
        ...
        <div class="row">
            <div class="produkt-cena-img-large">
                <a class="openimage" href="${Constants.URL}media/1606/videnska.jpg" title="Віденська">
                    <img title="Віденська" alt="Віденська" src="${Constants.URL}media/1606/videnska.jpg">
                </a>
            </div>
...
<script>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		if (slink == arr[i][0]){
            ...
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1599/videnska_00.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1600/videnska_10.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1601/videnska_12.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1604/videnska_40.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1603/videnska_19.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1602/videnska_13.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
            <div class="box" id="box_imgcol"><img style="width:80px; height: 100px;" src="${Constants.URL}media/1605/videnska_66.jpg" alt="Віденська" title="Віденська" /><span id="color_properties"></span></div>
...
<li>Варіант стрічкової черепиці з округлим та сегментним різом, що доповнює та не порушує величний вид споруди. </li>
<li>Надасть покрівлі цікайие геометричний характер. </li>
<li>Широка гама поверхневої та кольорової  обробки.</li>
</ul>
...
<td>23°</td>
                        ...
                        <div id="roof" class="tab-pane">
                            ...
                            <div class="tech-middle">
                                <div class="tech-middle">               
                                    <div class="tech-middle-inner">
<p><img style="width: 670px;" src="${Constants.URL}media/1598/віденська-криша.jpg" alt="Віденська" rel="2685" /></p>
	...
	for(var j=0; j<boxes.length; j++) {
		...
		for(var i=0; i<$(boxes[j]).length; i++){	
            ...
            <div id="appl"><img src="${Constants.URL}media/1607/вентиляційна.jpg" alt="Віденська" title="Віденська" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1608/карнизна.jpg" alt="Віденська" title="Віденська" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1609/підгребенева.jpg" alt="Віденська" title="Віденська" /><span></span></div>
            <div id="appl"><img src="${Constants.URL}media/1610/снігозахисна.jpg" alt="Віденська" title="Віденська" /><span></span></div>
            ...
            <img src="${Constants.URL}media/1611/ref291_1___altstadtpaket_tasche_eckig_naturrot__aufgeraut.jpg" alt="Віденська" title="Віденська" />
            <img src="${Constants.URL}media/1612/vensk_big.jpg" alt="Віденська" title="Віденська" />
            <img src="${Constants.URL}media/1615/viedenska_hs_kombi.jpg" alt="Віденська" title="Віденська" />
            <img src="${Constants.URL}media/1614/viedenska_hs_e1_cervena.jpg" alt="Віденська" title="Віденська" />
            <img src="${Constants.URL}media/1613/vensk_gal3_.jpg" alt="Віденська" title="Віденська" />
            <img src="${Constants.URL}media/1616/viedenska_hs_pr_01.jpg" alt="Віденська" title="Віденська" />
 </div> 
		</div> 
		<!-- "next page" action --> 
