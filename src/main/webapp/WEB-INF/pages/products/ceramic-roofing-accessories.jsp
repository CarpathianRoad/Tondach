...
<t:indexpage>
    <title>  Керамічні покрівельні аксесуари - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Керамічні покрівельні аксесуари</li>
    </ul>
...
<div class="subline">TONDACH<sup>®</sup> пропонує різноманітні покрівельні рішення для нового будівництва та реконструкції. Керамічні аксесуари для даху є необхідною умовою для гармонійного і технічно правильного рішення покрівлі. Аксесуарні елементи забезпечують для кожного типу черепиці  відмінний захист від дощу, буревіїв, граду і снігу.</div>
<h2><span><span>Закінчення покрівлі</span></span></h2>
<ul class="products group">
<li class="first">
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1403/glattfirst_product_small.png?width=110&amp;height=93" alt="Glattfirst_product_small.png" rel="2317" /></div>
<a>Гребінь та його закінчення</a></li>
<li>
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1402/carmen_ortgang_rechts_product_small.png?width=110&amp;height=93" alt="Carmen_Ortgang_rechts_product_small.png" rel="2316" /></div>
<a>Бокове закінчення</a></li>
<li>
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1405/pultabschlussziegel_product_small.png?width=110&amp;height=93" alt="Pultabschlussziegel_product_small.png" rel="2319" /></div>
<a>Закінчення пульта</a></li>
</ul>
<h2><span><span>Прохід через покрівлю</span></span></h2>
<ul class="products group">
<li class="first">
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1406/rohr-set_product_small.png?width=110&amp;height=93" alt="Rohr-Set_product_small.png" rel="2320" /></div>
<a>Керамічна вентиляційна трубка SET</a></li>
<li>
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1408/ton-antennenaufsatz_product_small.png?width=110&amp;height=93" alt="Ton-Antennenaufsatz_product_small.png" rel="2322" /></div>
<a>Керамічна прохідна трубка для антени</a></li>
</ul>
<h2><span><span>Захист від снігу</span></span></h2>
<ul class="products group">
<li class="first">
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1407/schneestoppziegel_product_small.png?width=110&amp;height=93" alt="Schneestoppziegel_product_small.png" rel="2321" /></div>
<a>Снігозатримуюча черепиця</a></li>
</ul>
<h2><span><span>Вентиляція даху</span></span></h2>
<ul class="products group">
<li class="first">
<div class="image"><img style="width: 110px; height: 93px;" src="${Constants.URL}media/1404/luefter_product_small.png?width=110&amp;height=93" alt="Luefter_product_small.png" rel="2318" /></div>
<a>Вентиляційна та під гребенева черепиця</a></li>
</ul>
...
<a rel="#overlay" target="_blank">Firstgockel</a></li>
<li><a name="6597"></a>
...
<a rel="#overlay" target="_blank">Firstkauz</a></li>
