...
<div class="subline">Гребінь та хребет є безпечними, гарними і забезпечують можливість необхідної вентиляції покрівлі. Елементи вентиляції дозволяють Вашому даху дихати, тим самим запобігаючи пошкодженню вологою та цвіллю.</div>
