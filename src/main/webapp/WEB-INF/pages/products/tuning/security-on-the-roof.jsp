...
<t:indexpage>
    <title>  Безпека на даху - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Безпека на даху</li>
    </ul>
...
<div class="subline">Безпека та захист під дахом, так само як і на даху є пріоритетним завданням. Широкий асортимент TONDACH<sup>®</sup> Tuning призначений спеціально для кожного типу черепиці. Снігозатримуючі та противітрові компоненти забезпечують захист у відповідності з останніми стандартами.</div>
<h2><span><span>Безпека на даху</span></span></h2>
