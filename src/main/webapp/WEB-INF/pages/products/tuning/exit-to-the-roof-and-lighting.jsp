...
<t:indexpage>
    <title>  Вихід на дах та освітлення - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Вихід на дах та освітлення</li>
    </ul>
		
		<div id="content" style="margin-top: 30px;">
            <h1>
              Вихід на дах та освітлення
            </h1>
            <div>
				          

              <div class="subcategories">
<div class="subline"><span><span>Додайте освітлення в кімнати без вікон. TONDACH<sup>®</sup> пропонує елегантні, стримані і дуже різноманітні функціональні можливості для освітлення та виходу на покрівлю для всіх типів черепиці.</span></span></div>
