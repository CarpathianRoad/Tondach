...
<t:indexpage>
    <title>  Підпокрівельні компоненти - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
            ...
            <li><a href="${Constants.URL}products/tuning/">Tuning &quot;надійно = надійно&quot;</a></li>

        
        <li class="active">Підпокрівельні компоненти</li>
    </ul>
		
		<div id="content" style="margin-top: 30px;">
            <h1>
              Підпокрівельні компоненти
            </h1>
            <div>
				          

              <div class="subcategories">
<div class="subline"><span><span>Нижня покрівля повинна відповідати екстремальним механічним та фізичним вимогам будівлі для постійного і безпечного захисту конструкції даху. Покрівельні плівки TONDACH<sup>®</sup> встановлюють нові стандарти по параметрам функціональності та безпеки. Вони є паропроникливі, стійкі до дощової води, вітро- і повітрогерметичні та демонструють температуростійкість від -40° C до +100° C.</span></span></div>
<h2>Підпокрівельні компоненти</h2>
