...
<t:indexpage>
    <title>  Елементи для закінчення покрівлі - природньо красиві і довговічні покрівлі </title>
...
ul.breadcrumb li:first-child { padding-left: 0;background: none; }
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Елементи для закінчення покрівлі</li>
    </ul>
		
		<div id="content" style="margin-top: 30px;">
            <h1>
              Елементи для закінчення покрівлі
            </h1>
            <div>
				          

              <div class="subcategories">
<div class="subline">Асортимент TONDACH<sup>®</sup> Tuning призначений спеціально для кожного типу черепиці. Система сумісних покрівельних аксесуарів доступна для кожної моделі!</div>
