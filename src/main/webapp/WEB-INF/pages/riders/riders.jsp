...
<t:indexpage>
    ...
    <div id="sidebar" class="_1"> 	<ul class="highlights">
              ...
              <li>
                <div class="image">
                    <a href="${Constants.URL}hy-tondach/faq-frequently-asked-questions/what-load-must-withstand-roof/"><img src="${Constants.URL}media/1062/highlight-dachsanierung_highlight_startpage.png" width="220" height="147" alt="" title=""></a>
                </div>
                <div class="caption">
