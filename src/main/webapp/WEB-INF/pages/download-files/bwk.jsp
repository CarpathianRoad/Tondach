...
<t:indexpage>
    <title>  Плівки від BWK - природньо красиві і довговічні покрівлі </title>
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="${Constants.URL}ownload-files/">Файли для завантаження</a></li>


        <li class="active">Плівки від BWK</li>
    </ul>
            ...
            <div>
                <ul>
                    <c:forEach items="${bwk}" var="item">
                        <li><img style="border: 0px; vertical-align: middle;" class="wf_file_icon" src="${Constants.URL}css/icons/pdf.png" alt="jpg" /> <a href="${Constants.URL}files/downloads/${item.url}" target="_blank" class="wf_file" download><span class="wf_file_text">${item.title}</span> </a><span class="wf_file_size" style="margin-left: 5px;">${item.size}</span></li>
                        </c:forEach>
                </ul>
            </div>
        </div>
